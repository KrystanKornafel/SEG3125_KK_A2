      ...
      <div className="row">
        <aside className="col-md-2">
          <div className="list-group">
            <Link to="/hairSalon" className="list-group-item list-group-item-action">Home</Link>
            <Link to="/hairSalon/applyNow" className="list-group-item list-group-item-action">ApplyNow</Link>
            <Link to="/hairSalon/bookAppointment" className="list-group-item list-group-item-action">BookAppointment</Link>
            <Link to="/hairSalon/contactUs" className="list-group-item list-group-item-action">ContactUs</Link>
          </div>
        </aside>
